...
import com.sparklink.entity.Conversation;
import com.sparklink.entity.User;
import com.sparklink.entity.UserMessage;
import com.sparklink.mapper.ConversationMapper;
...
public class MessageServiceImpl implements MessageService {
    ...
    public List<ConversationVO> getConversationList(Long userId) {
        ...
        for (Conversation conversation : conversations) {
            ...
            if (otherUser != null) {
                ...
                vo.setAvatar(com.sparklink.util.AvatarUtil.sanitizeForResponse(otherUser.getAvatar()));
            }
    ...
    public List<ChatMessageVO> getConversationMessages(Long conversationId, Long userId, Integer page, Integer size) {
        ...
        for (UserMessage message : messagePage.getRecords()) {
            ...
            if (sender != null) {
                vo.setSenderAvatar(com.sparklink.util.AvatarUtil.sanitizeForResponse(sender.getAvatar()));
            }
